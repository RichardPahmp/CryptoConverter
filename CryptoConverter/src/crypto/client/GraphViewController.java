...
public class GraphViewController implements Initializable {
	...
	/**
	 * Takes a History object and two dates. Returns a list of XYChart.Data objects
	 * between filtered by the dates.
	 */
	private ObservableList<XYChart.Data> createFilteredGraphData(History history, LocalDate fromDate,
			LocalDate toDate) {
	...
	/**
	 * An inner class holding the data and history for a currency. Used to bind a
	 * button a currency.
	 * 
	 * @author Richard
	 *
